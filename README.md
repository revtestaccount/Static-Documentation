...
> On completion, the Static-Documentation project will replace `paye-employers-documentation` at the public URL.
...
A bare-bones WYSIWYG page editor is in place and will be improved to support all page components (TOC, tables, code blocks, etc.) and editing of existing pages. **The editor and all page-editing scripts must not be included in the public release deployment.**
