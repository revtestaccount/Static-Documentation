...
**Deployed at:** https://revtestaccount.github.io/Static-Documentation/
...
## 8. Completed PDF -> HTML Migrations

| Document | PIT3 | PIT4 |
|---|---|---|
| REST Web Service Integration Guide | Done | Done |
| REST Connectivity Handshake Guide | Done | Done |
