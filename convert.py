...
with open("PITSelfServiceGuide.md", "r", encoding="utf-8") as input_file:
...
with open("PITSelfServiceGuide.html", "w", encoding="utf-8", errors="xmlcharrefreplace") as output_file:
